...
- Drafted Batch 3: Chapter 10 `What They Remember`, Chapter 11 `Frame by Frame`, Chapter 12 `Everyone Is Fine`, and Chapter 13 `There You Are` (Days 9-12, ~10,800 words). Carries the story from Claire's memory-lure and one-second grip release (C5) through Brooke's frame-by-frame discovery of the reflective green-eye flicker and the whispered "Wait," the school day that proves the change is public plus Anna's first in-person contact at the dog park (no name, no claim, mild Cooper wariness), and Claire breaking the bathroom lock without anger (C6). Plants: Mark's last confirmed live call cut off by unexplained background voices (Day 9); Brooke's observation list `Things I Have Seen`; Upload 4 forming the survivor network; the "recovered individuals" language shift (Phase 3). Drafted on continuity branch `claude/batch-3-draft-fknglf`; files use chapter-number prefixes (`10`-`13`) so they do not collide with Batch 2 (`06`-`09`).
