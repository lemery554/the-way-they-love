...
Characters may speculate. The novel never confirms an origin, mechanism, intelligence, cure, or complete scientific model.

## Rule 3: Every twist is fair

Major revelations require visible setup. Clues may be misread on first encounter, but they cannot depend on withheld information Brooke already understands.

## Rule 4: No character becomes evil overnight

Behavior changes through recognizable needs, existing wounds, and escalating choices. The original person may remain emotionally present.

## Rule 5: Every recovered person believes they are helping

Possession, restraint, pursuit, manipulation, and violence are framed internally as protection, reassurance, reunion, or care.

## Rule 6: Love is never fake

Love survives, but its meaning is redefined until separation becomes intolerable and another person's autonomy becomes irrelevant.

## Rule 7: The world functions longer than expected

Schools, shops, hospitals, media, utilities, and ordinary routines continue while their language and purpose become subtly wrong.

## Rule 8: Fear comes from realization

Avoid cheap jump scares. The strongest horror arrives when familiar facts acquire a new meaning.

## Rule 9: Recovered people receive no formal name

Characters use uncertain descriptive language. No catchy label, species name, or confident taxonomy enters canon.
