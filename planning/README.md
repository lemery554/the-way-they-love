...
During Draft One, every numbered chapter has one persistent `type: manuscript` issue. Editor feedback belongs in its comments. The issue stays open through drafting and revision and closes only after author acceptance.
