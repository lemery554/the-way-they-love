...
Task IDs remain stable across the repository. P0 tasks block drafting or protect central canon. P1 tasks are required for a reliable outline. P2 tasks are later production work.
...
- [x] **TWI-008 | P0 | Place Anna's school-day entry**: Anna makes two school-day entries: the investigation visit is Monday Day 20, and the journal-theft visit is Tuesday Day 21. Both occur while Brooke is at school.
...
- [x] **TWI-010 | P1 | Decide ending eye effect**: Decided (2026-07-15) — a brief reflective green flicker in Anna's eyes appears in the final scene *after* the journal reveal, registered through **Cooper** (his whine is his reaction to it), with Brooke asleep. It never carries or is the reveal; the journal-reading does that. Exact prose execution during drafting.
- [ ] **TWI-011 | P1 | Decide exact final line during Revision**: Deferred until the ending exists in prose. Preserve quiet dread and the realization that Anna is still studying Brooke. Banked direction: the "continued learning how to love her" family of lines (ties to the Ch 29 title *Continue Learning*); lock exact words during drafting.
...
- [x] **TWI-019 | P1 | Complete internet and hospital progression**: Map institutional changes to story days and Brooke's growing audience. Completed in `outline/INTERNET_AND_HOSPITAL_PROGRESSION.md` — phase-by-phase hospital/internet states pinned to days and correlated with the upload sequence (audience peaks Day 14 as capture ramps).
...
- [x] **TWI-023 | P0 | Run Foundation continuity audit**: Completed in `outline/FOUNDATION_CONTINUITY_AUDIT.md`. The later post-developmental audit supersedes its Day 18/19 calendar placement with Monday Day 20 and Tuesday Day 21 so both entries remain school-day visits.
...
- [x] **TWI-103 | P0 | Build the 30-to-40-chapter outline**: Completed as a prologue plus 29 chapters. The Friday Day 24 diner flows through the overnight pursuit into the Saturday Day 25 climax and ending.
- [x] **TWI-104 | P0 | Design Anna's approach**: Completed as surveillance plus two brief in-person meetings, the dog park on Day 11 and diner on Friday Day 24, followed by an engineered Saturday Day 25 pickup.
...
- [ ] **TWI-301 | P0 | Complete one-month cooling period**
- [ ] **TWI-302 | P0 | Perform cold-read diagnosis**
- [ ] **TWI-303 | P0 | Complete developmental rewrite**
- [ ] **TWI-304 | P1 | Complete character, pacing, continuity, clue, dialogue, found-media, and prose passes**
- [ ] **TWI-305 | P1 | Recruit qualified horror and thriller beta readers**
- [ ] **TWI-306 | P1 | Run beta questionnaire and triage feedback**
- [ ] **TWI-307 | P2 | Commission developmental editing, copy editing, and proofreading as appropriate**

## M5: Publication

- [x] **TWI-401 | P1 | Choose publication path**: Self-publishing is locked. Final distribution choice between IngramSpark, Amazon KDP, or a coordinated use of both remains deferred until production planning.
- [ ] **TWI-402 | P1 | Build the appropriate query or self-publishing package**
- [ ] **TWI-403 | P2 | Complete cover, interior, ebook, metadata, distribution, and marketing plans**
